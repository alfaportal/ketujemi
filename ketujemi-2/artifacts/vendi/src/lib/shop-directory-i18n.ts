...
const IT: ShopDirectoryCopy = {
  ...
  navHelp: "Aiuto",
  homeBannerTitle: "Business digitali — Acquista direttamente dalle aziende con un clic",
  homeBannerSubtitle: "{count} categorie • Centinaia di negozi locali • ovunque",
  homeBannerBtn: "Vedi tutti i negozi →",
  introTitle: "🏪 Negozio digitale — Il futuro del commercio!",
  introP1:
    "Il negozio digitale su KetuJemi.com è la presenza online di ogni attività e negozio fisico — dal negozio di quartiere alle grandi aziende. Ogni negozio ha la propria pagina personalizzata con prodotti, prezzi, foto e contatto diretto con il venditore.",
  introP2:
...
const DE: ShopDirectoryCopy = {
  ...
  navHelp: "Hilfe",
  homeBannerTitle: "Digitale Unternehmen — Direkt vom Business mit einem Klick kaufen",
  homeBannerSubtitle: "{count} Kategorien • Hunderte lokaler Shops • überall",
  homeBannerBtn: "Alle Shops ansehen →",
  introTitle: "🏪 Digitaler Shop — Die Zukunft des Handels!",
  introP1:
    "Der digitale Shop auf KetuJemi.com ist die Online-Präsenz jedes Unternehmens und jedes Ladens — vom Eckgeschäft bis zu großen Firmen. Jeder Shop hat seine eigene personalisierte Seite mit Produkten, Preisen, Fotos und direktem Kontakt zum Verkäufer.",
  introP2:
