...
const IT: ShopDetailCopy = {
  ...
  filterAll: "Tutto",
  postNewListing: "➕ Pubblica nuovo annuncio",
  editListing: "Modifica",
  deleteListing: "Elimina",
  deleteListingTitle: "Eliminare l'annuncio?",
  deleteListingDesc: "Questa azione è irreversibile. L'annuncio verrà rimosso definitivamente.",
  cancel: "Annulla",
  ownerWelcomeEmpty: "👋 Benvenuto! Il tuo negozio è pronto — pubblica il tuo primo annuncio e inizia a vendere!",
  postFirstListing: "➕ Pubblica il tuo primo annuncio →",
  editShop: "⚙️ Modifica negozio",
  deleteShop: "🗑️ Elimina negozio",
  deleteShopTitle: "Eliminare il negozio?",
  deleteShopDesc: "Sei sicuro? Questo eliminerà il tuo negozio e tutti i tuoi annunci.",
  saveShop: "Salva",
  shopSaved: "Negozio aggiornato.",
  shopSaveError: "Errore durante il salvataggio del negozio.",
  shopDeleted: "Negozio eliminato.",
  shopDeleteError: "Errore durante l'eliminazione del negozio.",
};

const DE: ShopDetailCopy = {
  ...
  filterAll: "Alle",
  postNewListing: "➕ Neue Anzeige aufgeben",
  editListing: "Bearbeiten",
  deleteListing: "Löschen",
  deleteListingTitle: "Anzeige löschen?",
  deleteListingDesc: "Dies kann nicht rückgängig gemacht werden. Die Anzeige wird dauerhaft entfernt.",
  cancel: "Abbrechen",
  ownerWelcomeEmpty: "👋 Willkommen! Ihr Shop ist bereit — geben Sie jetzt Ihre erste Anzeige auf und beginnen Sie zu verkaufen!",
  postFirstListing: "➕ Erste Anzeige aufgeben →",
  editShop: "⚙️ Shop bearbeiten",
  deleteShop: "🗑️ Shop löschen",
  deleteShopTitle: "Shop löschen?",
  deleteShopDesc: "Sind Sie sicher? Dadurch werden Ihr Shop und alle Ihre Anzeigen gelöscht.",
  saveShop: "Speichern",
  shopSaved: "Shop aktualisiert.",
  shopSaveError: "Fehler beim Speichern des Shops.",
  shopDeleted: "Shop gelöscht.",
  shopDeleteError: "Fehler beim Löschen des Shops.",
};
