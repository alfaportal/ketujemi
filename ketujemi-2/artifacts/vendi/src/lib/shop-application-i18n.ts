...
const FR: OpenShopFormCopy = {
  ...
  formImportant: "⚠️ Important: Votre boutique is activated only after we review votre request within 24 hours. Vous can update le details later de votre profile.",
  ...
  socialUrlHint: "Le link prefix (https://…) is already filled — type only votre page nom, e.g. your_shop_name",
  socialPhFacebook: "your_shop_name",
  socialPhInstagram: "your_shop_name",
  socialPhTiktok: "your_shop_name",
  socialPhWhatsapp: "38344123456",
  ...
  successMsg: "✅ Votre request was sent! We will contact vous within 24 hours.",
  loginRequired: "Vous must be registered et signed in to submit a boutique request.",
  uploadingLogo: "Envoi du logo...",
  aiHelpBtn: "✨ Aide de notre système",
  aiBusinessTypePrompt: "What type of business do vous have? (e.g. clothing boutique, real estate agency, car service...)",
  aiBusinessTypePlaceholder: "e.g. clothing boutique",
