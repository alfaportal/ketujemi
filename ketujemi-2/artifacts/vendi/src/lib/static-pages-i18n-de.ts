...
export const DE_STATIC_PAGES: StaticPagesCopy = {
  about: {
    title: "Über KetuJemi.com",
    tagline: "KetuJemi.com is one of the largest kostenlose Kleinanzeigen-Plattforms across 11 international markets.",
    sections: [
      {
      ...
      },
      {
        ...
        bullets: [
          "Kosovo, Albanien, Nordmazedonien and 8 diaspora markets (Deutschland, Schweiz, Österreich, Frankreich, Italien, UK, USA, Montenegro)",
        ],
      },
      {
        title: "Kontakt",
        paragraphs: [
          "Questions and support: info@ketujemi.com and support@ketujemi.com, or the «Kontaktieren Sie uns» form.",
        ],
      },
    ],
  },
  rules: {
    ...
    tagline: "Zurücksetzen rules for clean, trustworthy listings for all users.",
    sections: [
      {
        ...
        bullets: [
          ...
          "One product or service pro Anzeige",
        ],
      },
      {
        title: "Duplicates",
      ...
      {
        title: "Veröffentlichung is free and unlimited",
        paragraphs: [
          "Alle users (private and business) may post **unlimited listings for free** in any category — no fee to publish.",
        ...
        bullets: [
          ...
          "Unlimited real photos pro Anzeige and optional video up to 150MB (Cloudinary)",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          "KetuJemi.com (Kaufen & Verkaufen) is operated and offered by REVOLUTION INVEST Sh.p.k., based in Ferizaj, Republic of Kosovo.",
      ...
      },
      {
        ...
        paragraphs: [
          "Anzeigen veröffentlichen is free and unlimited for all users.",
  ...
  privacy: {
    title: "KetuJemi Datenschutz Policy",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Telefonnummer (optional — for contact on listings or SMS sign-in, if you choose)",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Functional — save your preferences such as selected market (Kosovo / Albanien / etc.) and language. Without them you would need to choose each time.",
      ...
      },
      {
        title: "Your control",
        paragraphs: [
          'You can turn off or delete cookies in your browser settings at any time. Some features (such as staying signed in) may not work without essential cookies. For browser-specific help: Chrome, Firefox, Safari, Edge — see "Settings → Datenschutz".',
        ],
      },
      {
        title: "Changes",
  ...
  vipPackages: {
    ...
    tagline: "Wählen Sie das Paket, das zu Ihrem Geschäft passt:",
    bullets: [
  ...
  businessRules: {
    ...
    tagline: "Anzeigen for registered businesses",
    sanctionsTableHeaders: { violation: "Verstoß", consequence: "Action" },
    sections: [
      {
        title: "Registrierung",
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          "Zurücksetzen product or service (not general advertising)",
      ...
      },
      {
        title: "Privatkonten",
        paragraphs: [
          "Private and business users follow the same free, unlimited posting policy. See AGB of use in the footer.",
        ],
      },
    ],
  },
  contact: {
    ...
    technicalSupportLabel: "Technisch support:",
    phoneLabel: "Phone:",
    ...
    supportEmailLabel: "Technisch support:",
    facebookLabel: "Facebook:",
    instagramLabel: "Instagram:",
    formTitle: "Kontakt form",
    nameLabel: "Your name",
    ...
    subjects: [
      ...
      { value: "problem", label: "Technisch problem" },
  ...
  faq: {
    ...
    featured: [
      {
        q: "Wie gebe ich eine Anzeige auf?",
        a: "Click «Anzeige aufgeben» at the top of the page, choose the right category, fill in title, description and price, upload unlimited photos (and optionally one video up to 150MB) and publish. The listing goes live right after automatic moderation.",
      },
      {
        q: "Was kostet die Veröffentlichung?",
        a: "Veröffentlichung is completely free and unlimited for all users. The only paid option is Boost to Top — optional promotion of your listing on the homepage.",
      },
      {
        q: "How do I delete a listing?",
        a: "Sign in, go to Profile → «My listings», select the listing and click «Löschen». It is removed immediately and permanently.",
      },
      {
      ...
      },
      {
        ...
        a: "Ja. You can register and sign in with Google or Facebook in one click. To post, you must be signed in — enter your phone in the listing form.",
      },
      {
        q: "How many photos can I upload pro Anzeige?",
        a: "Unlimited photos pro Anzeige and one optional video up to 150MB. We recommend real photos of your product — not images from the internet or catalogues.",
      },
      {
        q: "My listing was rejected — why?",
        a: "Anzeigen are rejected if they contain prohibited products, fake photos, incorrect prices or misleading information. You will be notified by email with the reason.",
      },
      {
      ...
      },
      {
        ...
        a: "Ja. Go to Profile → «My listings», select the listing and click «Bearbeiten». You can change title, description, price and photos.",
      },
      {
        q: "What if I have been scammed?",
        a: "Kontaktieren Sie uns immediately at support@ketujemi.com with details. Also report the case to the Kosovo Police, as KetuJemi.com is not a party to transactions between users.",
      },
    ],
    sections: [],
  },
  security: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Registrierung and sign-in required to post listings",
    ...
    sections: [
      {
        title: "Über KetuJemi.com",
        paragraphs: [
          "KetuJemi.com is the leading Albanian online classifieds platform, developed and operated by REVOLUTION INVEST Sh.p.k., based in Ferizaj, Kosovo. The platform operates in Kosovo, Albanien, Nordmazedonien and 8 diaspora markets.",
        ],
      },
      {
