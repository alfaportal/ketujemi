...
export const EN_STATIC_PAGES: StaticPagesCopy = {
  about: {
    title: "About KetuJemi.com",
    tagline: "KetuJemi.com is one of the largest free classifieds platforms across 11 international markets.",
    sections: [
      {
  ...
  rules: {
    ...
    tagline: "Clear rules for clean, trustworthy listings for all users.",
    sections: [
      {
        ...
        bullets: [
          ...
          "One product or service per listing",
        ],
      },
      {
        title: "Duplicates",
