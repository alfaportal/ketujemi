...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ks: {
    ...
    seller: "Shitësi", privateSeller: "Shitës privat", sellerOnline: "Online",
    ...
    share_facebookProminent: "Shpërndaj në Facebook",
    share_whatsappProminent: "Shpërndaj në WhatsApp",
    share_copyLinkProminent: "Kopjo Linkun",
    share_linkCopied: "U kopjua!",
    share_postSuccessTitle: "Shpallja u postua! Shpërndale tani:",
    share_instagramProminent: "Shpërndaj në Instagram",
    share_tiktokProminent: "Shpërndaj në TikTok",
    share_instagramCopiedAlert: "Linku u kopjua! Hape Instagram dhe paste-o në Story ose Bio.",
    share_tiktokCopiedAlert: "Linku u kopjua! Hape TikTok dhe paste-o në Bio ose Video.",
    caution: "⚠ Kujdes",
    ...
    listingLoadError: "Problem gjatë ngarkimit të shpalljes",
    listingLoadErrorSub: "Serveri nuk përgjigjet. Provo përsëri pas pak.",
    listingRetry: "Provo përsëri",
    ...
    kerkojEmptyTitle: "Nuk ka kërkesa ende",
    kerkojEmptySub:
    ...
    listingPhotosMaxHint: "(max 10)",
    photosMaxReached: "Limiti i fotove",
    photosMaxReachedHint: "Mund të shtoni deri në {max} foto për shpallje.",
    addPhoto: "Shto foto",
    photoCameraBtn: "Foto me kamerë",
    videoCameraBtn: "Video me kamerë",
    listingMediaRemoveVideoForPhotos: "Heq videon për të shtuar foto.",
    listingMediaRemovePhotosForVideo: "Heq fotot për të shtuar video.",
    ...
    editAnalyzePhotoBtn: "Analizo foton me AI",
    editUploadPhotoBtn: "Ngarko foto",
    editPhotoAnalyzeOk: "Titulli dhe përshkrimi u përditësuan nga fotoja.",
  ...
  al: {
    ...
    listingNotFoundSub: "Mund të jetë fshirë ose mund të kesh një link të gabuar.",
    listingLoadError: "Problem gjatë ngarkimit të njoftimit",
    listingLoadErrorSub: "Serveri nuk përgjigjet. Provo përsëri pas pak.",
    listingRetry: "Provo përsëri",
    ...
    listingPhotosMaxHint: "(max 10)",
    photosMaxReached: "Limiti i fotove",
    photosMaxReachedHint: "Mund të shtoni deri në {max} foto për njoftim.",
    addPhoto: "Shto foto",
    photoCameraBtn: "Foto me kamerë",
    videoCameraBtn: "Video me kamerë",
    listingMediaRemoveVideoForPhotos: "Heq videon për të shtuar foto.",
  ...
  mk: {
    ...
    seller: "Продавач", privateSeller: "Приватен продавач", sellerOnline: "Online",
    ...
    share_facebookProminent: "Сподели на Facebook",
    share_whatsappProminent: "Сподели на WhatsApp",
    share_copyLinkProminent: "Копирај го линкот",
    share_linkCopied: "Копирано!",
    share_postSuccessTitle: "Огласот е објавен! Споделете го сега:",
    share_instagramProminent: "Сподели на Instagram",
    share_tiktokProminent: "Сподели на TikTok",
    share_instagramCopiedAlert: "Линкот е копиран! Отвори Instagram и залепи го во Story или Bio.",
    share_tiktokCopiedAlert: "Линкот е копиран! Отвори TikTok и залепи го во Bio или Video.",
    caution: "⚠ Внимание",
    ...
    listingLoadError: "Проблем при вчитување на огласот",
    listingLoadErrorSub: "Серверот не одговара. Обидете се повторно за малку.",
    listingRetry: "Обиди се повторно",
    ...
    kerkojEmptyTitle: "Сè уште нема барања",
    kerkojEmptySub:
    ...
    listingPhotosMinHint: "(мин. 1)",
    listingPhotosMaxHint: "(макс. 10)",
    photosMaxReached: "Лимит на фотографии",
    photosMaxReachedHint: "Можете да додадете најмногу {max} фотографии по оглас.",
    addPhoto: "Додај фото",
    photoCameraBtn: "Фото со камера",
    videoCameraBtn: "Видео со камера",
    listingMediaRemoveVideoForPhotos: "Отстранете го видеото за да додадете фотографии.",
    listingMediaRemovePhotosForVideo: "Отстранете ги фотографиите за да додадете видео.",
    ...
    editAnalyzePhotoBtn: "Анализирај ја фотографијата со AI",
    editUploadPhotoBtn: "Прикачи фотографија",
    editPhotoAnalyzeOk: "Насловот и описот се ажурирани од фотографијата.",
  ...
  mne: {
    ...
    seller: "Prodavac", privateSeller: "Privatni prodavac", sellerOnline: "Online",
    ...
    share_facebookProminent: "Podijeli na Facebooku",
    share_whatsappProminent: "Podijeli na WhatsAppu",
    share_copyLinkProminent: "Kopiraj link",
    share_linkCopied: "Kopirano!",
    share_postSuccessTitle: "Oglas je objavljen! Podijeli ga sada:",
    share_instagramProminent: "Podijeli na Instagramu",
    share_tiktokProminent: "Podijeli na TikToku",
    share_instagramCopiedAlert: "Link je kopiran! Otvori Instagram i zalijepi ga u Story ili Bio.",
    share_tiktokCopiedAlert: "Link je kopiran! Otvori TikTok i zalijepi ga u Bio ili Video.",
    caution: "⚠ Pažnja",
    ...
    listingLoadError: "Problem pri učitavanju oglasa",
    listingLoadErrorSub: "Server ne odgovara. Pokušajte ponovo za trenutak.",
    listingRetry: "Pokušaj ponovo",
    ...
    kerkojEmptyTitle: "Još nema tražnji",
    kerkojEmptySub:
    ...
    listingPhotosMinHint: "(min. 1)",
    listingPhotosMaxHint: "(max 10)",
    photosMaxReached: "Limit fotografija",
    photosMaxReachedHint: "Možete dodati najviše {max} fotografija po oglasu.",
    addPhoto: "Dodaj foto",
    photoCameraBtn: "Foto kamerom",
    videoCameraBtn: "Video kamerom",
    listingMediaRemoveVideoForPhotos: "Uklonite video da biste dodali fotografije.",
    listingMediaRemovePhotosForVideo: "Uklonite fotografije da biste dodali video.",
    ...
    editAnalyzePhotoBtn: "Analiziraj fotografiju pomoću AI",
    editUploadPhotoBtn: "Učitaj fotografiju",
    editPhotoAnalyzeOk: "Naslov i opis ažurirani su na osnovu fotografije.",
  ...
  en: {
    ...
    seller: "Seller", privateSeller: "Private seller", sellerOnline: "Online",
    ...
    share_facebookProminent: "Share on Facebook",
    share_whatsappProminent: "Share on WhatsApp",
    share_copyLinkProminent: "Copy link",
    share_linkCopied: "Copied!",
    share_postSuccessTitle: "Listing posted! Share it now:",
    share_instagramProminent: "Share on Instagram",
    share_tiktokProminent: "Share on TikTok",
    share_instagramCopiedAlert: "Link copied! Open Instagram and paste it in Story or Bio.",
    share_tiktokCopiedAlert: "Link copied! Open TikTok and paste it in Bio or Video.",
    caution: "⚠ Caution",
    ...
    listingLoadError: "Problem loading listing",
    listingLoadErrorSub: "The server did not respond. Please try again shortly.",
    listingRetry: "Try again",
    ...
    listingPhotosMinHint: "(min. 1)",
    listingPhotosMaxHint: "(max 10)",
    photosMaxReached: "Photo limit reached",
    photosMaxReachedHint: "You can add up to {max} photos per listing.",
    addPhoto: "Add photo",
    photoCameraBtn: "Take photo with camera",
    videoCameraBtn: "Record video with camera",
    listingMediaRemoveVideoForPhotos: "Remove the video to add photos.",
    listingMediaRemovePhotosForVideo: "Remove photos to add a video.",
