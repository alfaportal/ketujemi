...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ks: {
    ...
    share_facebook: "📘 Shpërndaje në Facebook",
    share_instagram: "📸 Shpërndaje në Instagram",
    share_tiktok: "🎵 Shpërndaje në TikTok",
    share_copyLink: "🔗 Kopjo Linkun",
    share_copied: "Linku u kopjua! ✓",
    share_toastInstagram: "Kopjo linkun dhe ngarkoje te historia ose postimi yt në Instagram 📲",
    share_toastTiktok: "Kopjo linkun dhe ngarkoje te historia ose postimi yt në TikTok 📲",
    caution: "⚠ Kujdes",
  ...
  mk: {
    ...
    share_facebook: "📘 Сподели на Facebook",
    share_instagram: "📸 Сподели на Instagram",
    share_tiktok: "🎵 Сподели на TikTok",
    share_copyLink: "🔗 Копирај го линкот",
    share_copied: "Линкот е копиран! ✓",
    share_toastInstagram: "Копирај го линкот и објави го на твојата приказна или објава на Instagram 📲",
    share_toastTiktok: "Копирај го линкот и објави го на твојата приказна или објава на TikTok 📲",
    caution: "⚠ Внимание",
  ...
  mne: {
    ...
    share_instagram: "📸 Podijeli na Instagramu",
    share_tiktok: "🎵 Podijeli na TikToku",
    share_copyLink: "🔗 Kopiraj link",
    share_copied: "Link je kopiran! ✓",
    share_toastInstagram: "Kopiraj link i objavi ga na svojoj priči ili objavi na Instagramu 📲",
    share_toastTiktok: "Kopiraj link i objavi ga na svojoj priči ili objavi na TikToku 📲",
    caution: "⚠ Pažnja",
  ...
  en: {
    ...
    share_toastInstagram: "Copy the link and post it to your story or feed on Instagram 📲",
    share_toastTiktok: "Copy the link and post it to your story or feed on TikTok 📲",
    caution: "⚠ Caution",
