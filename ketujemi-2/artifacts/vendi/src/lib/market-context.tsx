...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ks: {
    ...
    heroSub: "Platforma kryesore e shpalljeve në Kosovë",
  ...
  al: {
    ...
    page: "Faqja", of: "nga",
    hero: "KetuJemi — Bli dhe Shit",
    heroSub: "Platforma kryesore e njoftimeve në Shqipëri",
    categories: "Kategoritë", viewAll: "Shiko të gjitha",
    trust1: "Verifikim SMS & Email", trust2: "Posto falas", trust3: "18 kategori",
    markets: "KetuJemi në 11 tregje",
    back: "Kthehu", edit: "Edito", delete: "Fshi", cancel: "Anulo",
  ...
  mk: {
    ...
    heroSub: "Водечката платформа за огласи во Македонија",
  ...
  mne: {
    ...
    heroSub: "Vodeća platforma za oglase u Crnoj Gori",
