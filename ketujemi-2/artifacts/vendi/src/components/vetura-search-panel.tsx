...
const SEDAN_SLIDESHOW_MS = 10_000;
const SEDAN_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/170811/pexels-photo-170811.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/3786091/pexels-photo-3786091.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/28947270/pexels-photo-28947270.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function SedanCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = SEDAN_SLIDESHOW_IMAGES.length;
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {SEDAN_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
      ...
      <div
        className="pointer-events-none absolute bottom-7 left-0 right-0 z-[2] flex justify-center gap-1"
        aria-hidden
      >
        {SEDAN_SLIDESHOW_IMAGES.map((_, i) => (
          <span
            key={i}
            className={cn(
              "h-1.5 rounded-full bg-white transition-all duration-300",
              i === currentIndex ? "w-3 opacity-100" : "w-1.5 opacity-45",
            )}
          />
        ))}
      </div>
...
const SUV_SLIDESHOW_MS = 10_000;
const SUV_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/912843/pexels-photo-912843.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/1638459/pexels-photo-1638459.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/16510650/pexels-photo-16510650.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function SuvCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = SUV_SLIDESHOW_IMAGES.length;
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {SUV_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
...
const HATCH_SLIDESHOW_MS = 10_000;
const HATCH_SLIDESHOW_IMAGES = [
...
function HatchbackCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = HATCH_SLIDESHOW_IMAGES.length;
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {HATCH_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
      ...
      <div
        ...
        aria-hidden
      >
        {HATCH_SLIDESHOW_IMAGES.map((_, i) => (
          <span
            key={i}
            className={cn(
              "h-1.5 rounded-full bg-white transition-all duration-300",
...
const KOMBI_SLIDESHOW_MS = 10_000;
const KOMBI_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/19548262/pexels-photo-19548262.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/2533092/pexels-photo-2533092.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/1178448/pexels-photo-1178448.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function KombiCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = KOMBI_SLIDESHOW_IMAGES.length;
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {KOMBI_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
      ...
      <div
        ...
        aria-hidden
      >
        {KOMBI_SLIDESHOW_IMAGES.map((_, i) => (
          <span
            key={i}
            className={cn(
              "h-1.5 rounded-full bg-white transition-all duration-300",
...
const KABRIOLET_SLIDESHOW_MS = 10_000;
const KABRIOLET_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/136872/pexels-photo-136872.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/132774/pexels-photo-132774.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/105598/pexels-photo-105598.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function KabrioletCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = KABRIOLET_SLIDESHOW_IMAGES.length;

  useEffect(() => {
    const intervalId = window.setInterval(() => {
      setCurrentIndex((prev) => (prev + 1) % count);
    }, KABRIOLET_SLIDESHOW_MS);
    return () => window.clearInterval(intervalId);
  }, [count]);
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {KABRIOLET_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
      ...
      <div
        ...
        aria-hidden
      >
        {KABRIOLET_SLIDESHOW_IMAGES.map((_, i) => (
          <span
            key={i}
            className={cn(
              "h-1.5 rounded-full bg-white transition-all duration-300",
...
const KUPE_SLIDESHOW_MS = 10_000;
const KUPE_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/892522/pexels-photo-892522.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/3849556/pexels-photo-3849556.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/10469760/pexels-photo-10469760.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function KupeCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = KUPE_SLIDESHOW_IMAGES.length;
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {KUPE_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
...
const EV_SLIDESHOW_MS = 10_000;
const EV_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/11139552/pexels-photo-11139552.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/24376862/pexels-photo-24376862.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/8349487/pexels-photo-8349487.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function EvCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = EV_SLIDESHOW_IMAGES.length;
...
const PICKUP_SLIDESHOW_MS = 10_000;
const PICKUP_SLIDESHOW_IMAGES = [
  "https://images.pexels.com/photos/16058147/pexels-photo-16058147.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/18240251/pexels-photo-18240251.jpeg?auto=compress&cs=tinysrgb&w=400",
  "https://images.pexels.com/photos/2994335/pexels-photo-2994335.jpeg?auto=compress&cs=tinysrgb&w=400",
] as const;

function PickupCardSlideshow() {
  const [currentIndex, setCurrentIndex] = useState(0);
  const count = PICKUP_SLIDESHOW_IMAGES.length;
  ...
  return (
    <>
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        {PICKUP_SLIDESHOW_IMAGES.map((url, i) => (
          <img
            key={url}
            src={url}
            alt=""
      ...
      <div
        ...
        aria-hidden
      >
        {PICKUP_SLIDESHOW_IMAGES.map((_, i) => (
          <span
            key={i}
            className={cn(
              "h-1.5 rounded-full bg-white transition-all duration-300",
            ...
            return (
              ...
              >
                {b.key === "sedan" ? (
                  ...
                  <HatchbackCardSlideshow />
                ) : b.key === "kombi" ? (
                  <KombiCardSlideshow />
                ) : b.key === "kabriolet" ? (
                  <KabrioletCardSlideshow />
                ) : b.key === "kupe" ? (
                  <KupeCardSlideshow />
                ) : b.key === "ev" ? (
                  <EvCardSlideshow />
