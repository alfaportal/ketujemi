  ...
  return (
    <section className="mb-8 rounded-3xl border border-green-100 bg-gradient-to-br from-green-50 via-white to-emerald-50 p-6 sm:p-8 shadow-sm">
      <p className="text-lg sm:text-xl font-bold text-green-900 leading-snug mb-4">
        Një send i vogël për ju — një botë e tërë për dikë tjetër
      </p>
      <div className="space-y-3 text-sm sm:text-base text-gray-700 leading-relaxed">
        <p>
          Ndoshta është një xhaketë që nuk e vesh më. Një lodër që fëmija juaj e ka lënë mënjanë. Një
          libër që e ke lexuar dhe po rri në raft. Një mobilje që nuk të hyn në dhomë.
        </p>
        <p>
          Por diku, sot, ka një nënë që kërkon një xhaketë të ngrohtë për fëmijën e saj. Ka një fëmijë
          që ëndërron pikërisht atë lodër. Ka një student që nuk mund ta blejë atë libër. Ka një familje
          që ka nevojë për pikërisht atë mobilje.
        </p>
        <p>
          Ata nuk dinë që ju e keni. Ju nuk dini që ata e kanë nevojë. KetuJemi i bashkon — falas, me
          dashuri, me dinjitet.
        </p>
