  ...
  return {
    ...
    ...(() => {
      ...
      return {
        ...
        identity_verified_via: identity.identity_verified_via,
        profile_edit_second_factor: identity.profile_edit_second_factor,
        profile_edit_needs_second_method: identity.profile_edit_needs_second_method,
