...
const SOCIAL_FOLLOWERS_SCHEMA_SQL = `
...
export async function ensureSocialFollowersSchema(pool: pg.Pool): Promise<void> {
  await pool.query(SOCIAL_FOLLOWERS_SCHEMA_SQL);
}
