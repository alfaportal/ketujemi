...
export const PARENT_CATEGORY_THUMB_BY_SLUG: Record<ParentCategorySlug, string> = {
  ...
  "ndertim-instalime": unsplash("1504307651254-35680f356dfd", 600),
  ...
  "dhurata-falas": "https://images.pexels.com/photos/10905774/pexels-photo-10905774.jpeg?w=600&q=80",
};
...
export const PARENT_CATEGORY_NAME_TO_SLUG: Record<string, ParentCategorySlug> = {
  ...
  "Ndërtim & Instalime": "ndertim-instalime",
